...
struct RobotStatus
{
	...
	bool isEndPoint;//机器人是否还在运动中 1表示运动中 0表示已经停下
	double worldCpos[16];//当前机器人世界坐标系下笛卡尔位置 - 顺序：[x, y, z, roll, pitch, yaw]- 单位：x,y,z = mm，roll,pitch,yaw = rad
	double jointValue[16];//当前机器人各关节值，单位rad
};
